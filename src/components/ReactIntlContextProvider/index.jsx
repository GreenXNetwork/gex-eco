    ...
    render() {
        ...
        return (
            <Provider value={this.state}>
                <IntlProvider key={this.state.providerProps.locale} {...this.state.providerProps}>
                    {children}
                </IntlProvider>
            </Provider>
        );
...
export { ReactIntlContextProvider as IntlProvider, Consumer as IntlConsumer, loadLocaleData };
